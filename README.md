...
1. "착장" 카드가 가로로 나열되고, "+ 착장 추가"로 얼마든지 늘릴 수 있어요. 카드 제목은 클릭해서 바로 수정 가능합니다.
2. 왼쪽 사이드바에서 제품명 검색 · 시즌/유형/카테고리 칩 필터로 제품을 찾고, 썸네일을 각 착장 카드 위로 드래그해서 놓으면 담깁니다. 담긴 썸네일의 × 버튼으로 개별 제거도 가능해요.
